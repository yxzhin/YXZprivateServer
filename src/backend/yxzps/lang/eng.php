...
define("MESSAGE_ERROR_NOT_FOUND", "An instance with the given data hasn't been found");
define("MESSAGE_ERROR_ALREADY_TAKEN", "Given property name is already taken");
...
define("MESSAGE_ERROR_ACCOUNT_LIMIT_PER_IP_REACHED", "You've reached the limit of accounts per IP!");
